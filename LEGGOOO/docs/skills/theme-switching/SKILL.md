...
/_ Theme: Earth - Soft organic warmth _/
[data-theme="earth"] {
--background: 40 33% 98%;
--foreground: 30 10% 15%;
--card: 40 30% 97%;
...
/_ Theme: Studio - Clean minimal _/
[data-theme="studio"] {
--background: 0 0% 100%;
--foreground: 0 0% 5%;
--card: 0 0% 100%;
...
/_ Theme: Athlete - Bold with purple accent _/
[data-theme="athlete"] {
--background: 0 0% 99%;
--foreground: 270 5% 10%;
--card: 0 0% 100%;
...
/_ Theme: Gradient - Soft gradient hero _/
[data-theme="gradient"] {
